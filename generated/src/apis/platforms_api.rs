...
/// struct for typed errors of method `get_platform`
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetPlatformError {
...
pub async fn get_platform(configuration: &configuration::Configuration, platform: &str, network: &str) -> Result<crate::models::PlatformDetail, Error<GetPlatformError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/v2/{platform}/{network}", configuration.base_path, platform=crate::apis::urlencode(platform), network=crate::apis::urlencode(network));
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetPlatformError> = serde_json::from_str(&local_var_content).ok();
...
pub async fn get_platform_endpoints(configuration: &configuration::Configuration, platform: &str, network: &str) -> Result<crate::models::PlatformDetail, Error<GetPlatformEndpointsError>> {
    ...
    let local_var_uri_str = format!("{}/v1/{platform}/{network}/", configuration.base_path, platform=crate::apis::urlencode(platform), network=crate::apis::urlencode(network));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
...
pub async fn get_platforms(configuration: &configuration::Configuration, ) -> Result<crate::models::PlatformsOverview, Error<GetPlatformsError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/v2/", configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
...
pub async fn get_platforms_list(configuration: &configuration::Configuration, ) -> Result<crate::models::PlatformsOverview, Error<GetPlatformsListError>> {
    ...
    let local_var_uri_str = format!("{}/v1/", configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
