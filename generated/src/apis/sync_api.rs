...
pub async fn current_block_id(configuration: &configuration::Configuration, platform: &str, network: &str) -> Result<String, Error<CurrentBlockIdError>> {
    ...
    let local_var_uri_str = format!("{}/v2/{platform}/{network}/sync/block_id", configuration.base_path, platform=crate::apis::urlencode(platform), network=crate::apis::urlencode(network));
...
pub async fn current_block_number(configuration: &configuration::Configuration, platform: &str, network: &str) -> Result<i64, Error<CurrentBlockNumberError>> {
    ...
    let local_var_uri_str = format!("{}/v2/{platform}/{network}/sync/block_number", configuration.base_path, platform=crate::apis::urlencode(platform), network=crate::apis::urlencode(network));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
