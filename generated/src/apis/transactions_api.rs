...
pub async fn tx_create(configuration: &configuration::Configuration, platform: &str, network: &str, tx_create: crate::models::TxCreate) -> Result<crate::models::UnsignedTx, Error<TxCreateError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/{platform}/{network}/tx/create", configuration.base_path, platform=crate::apis::urlencode(platform), network=crate::apis::urlencode(network));
