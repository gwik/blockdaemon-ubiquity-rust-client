...
pub async fn get_block_identifier(configuration: &configuration::Configuration, protocol: &str, network: &str, block_identifier: &str) -> Result<crate::models::BlockIdentifier, Error<GetBlockIdentifierError>> {
