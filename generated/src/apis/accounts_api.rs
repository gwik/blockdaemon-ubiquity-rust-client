...
/// struct for typed errors of method `v2_get_report_by_address`
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum V2GetReportByAddressError {
    Status400(crate::models::Error),
    Status401(crate::models::Error),
    Status429(crate::models::Error),
    Status413(crate::models::Error),
...
/// struct for typed errors of method `v2_get_txs_by_address`
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum V2GetTxsByAddressError {
    Status400(crate::models::Error),
    Status401(crate::models::Error),
    Status403(crate::models::Error),
    Status429(crate::models::Error),
...
pub async fn get_report_by_address(configuration: &configuration::Configuration, platform: &str, network: &str, address: &str, from: Option<i32>, to: Option<i32>, limit: Option<i32>, continuation: Option<&str>) -> Result<crate::models::Report, Error<GetReportByAddressError>> {
    ...
    let local_var_uri_str = format!("{}/v1/{platform}/{network}/account/{address}/report", configuration.base_path, platform=crate::apis::urlencode(platform), network=crate::apis::urlencode(network), address=crate::apis::urlencode(address));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
...
pub async fn get_txs_by_address(configuration: &configuration::Configuration, platform: &str, network: &str, address: &str, order: Option<&str>, continuation: Option<&str>, limit: Option<i32>, assets: Option<&str>) -> Result<crate::models::TxPageV1, Error<GetTxsByAddressError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/v1/{platform}/{network}/account/{address}/txs", configuration.base_path, platform=crate::apis::urlencode(platform), network=crate::apis::urlencode(network), address=crate::apis::urlencode(address));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
...
/// Returns account activity 
pub async fn v2_get_report_by_address(configuration: &configuration::Configuration, platform: &str, network: &str, address: &str, from: Option<i32>, to: Option<i32>, limit: Option<i32>, continuation: Option<&str>) -> Result<crate::models::Report, Error<V2GetReportByAddressError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<V2GetReportByAddressError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
/// Gets transactions that an address was involved with, from newest to oldest. This call uses pagination. 
pub async fn v2_get_txs_by_address(configuration: &configuration::Configuration, platform: &str, network: &str, address: &str, order: Option<&str>, continuation: Option<&str>, limit: Option<i32>, assets: Option<&str>) -> Result<crate::models::TxPage, Error<V2GetTxsByAddressError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<V2GetTxsByAddressError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
