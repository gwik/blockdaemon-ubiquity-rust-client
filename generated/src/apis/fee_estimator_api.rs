...
/// struct for typed errors of method [`get_fee_estimate`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetFeeEstimateError {
...
pub async fn get_fee_estimate(configuration: &configuration::Configuration, protocol: &str, network: &str) -> Result<crate::models::InlineResponse200, Error<GetFeeEstimateError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetFeeEstimateError> = serde_json::from_str(&local_var_content).ok();
