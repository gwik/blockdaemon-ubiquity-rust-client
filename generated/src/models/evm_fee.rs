...
pub struct EvmFee {
    ...
    #[serde(rename = "max_priority_fee", skip_serializing_if = "Option::is_none")]
    pub max_priority_fee: Option<bigdecimal::BigDecimal>,
    /// The fast slow total fee.
    #[serde(rename = "max_total_fee", skip_serializing_if = "Option::is_none")]
    pub max_total_fee: Option<bigdecimal::BigDecimal>,
}
