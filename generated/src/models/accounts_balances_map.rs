...
/// AccountsBalancesMap : Accounts balances with account addressses as keys



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct AccountsBalancesMap {
}

impl AccountsBalancesMap {
    /// Accounts balances with account addressses as keys
    pub fn new() -> AccountsBalancesMap {
        AccountsBalancesMap {
        }
    }
}
