...
pub struct GetAssetResponseAsset {
    ...
    pub media: Option<Box<crate::models::GetAssetResponseAssetMedia>>,
    ...
    pub wallets: Option<Vec<crate::models::GetAssetResponseAssetWallet>>,
    #[serde(rename = "attributes", skip_serializing_if = "Option::is_none")]
    pub attributes: Option<Vec<crate::models::GetAssetResponseAssetTrait>>,
}

impl GetAssetResponseAsset {
    pub fn new() -> GetAssetResponseAsset {
