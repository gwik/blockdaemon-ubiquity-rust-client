...
pub struct MultiTransferOperation {
    #[serde(rename = "type")]
    pub _type: String,
    #[serde(rename = "detail")]
    pub detail: Box<crate::models::MultiTransfer>,
}

impl MultiTransferOperation {
    pub fn new(_type: String, detail: crate::models::MultiTransfer) -> MultiTransferOperation {
