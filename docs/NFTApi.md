...
[**explorer_get_status**](NFTApi.md#explorer_get_status) | **GET** /status | 
...
------------- | ------------- | ------------- | ------------- | -------------
**protocol** | **i32** | Mapped to URL path | [required] |
**network** | **i32** | Mapped to URL path | [required] |
...
**order** | Option<**i32**> | Mapped to URL query parameter `order` One of: asc, desc |  |
